...
const banners = [
  "https://res.cloudinary.com/dyzpyjgaw/image/upload/v1736701789/hero2_bmqio1.png",
  "https://res.cloudinary.com/dyzpyjgaw/image/upload/v1736701783/hero1_jdtevf.png",
];

const videoCover = [
  "https://res.cloudinary.com/dyzpyjgaw/video/upload/v1736701714/banner_video_kjicvy.mp4",
];
  ...
  return (
    <>
      ...
      <article className="cover-video-container">
        ...
        <video autoPlay loop muted src={videoCover[0]} />
